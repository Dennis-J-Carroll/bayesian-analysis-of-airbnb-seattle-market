...
class TestDataLoading:
    ...
    def test_required_columns_present(self, sample_data_path):
        ...
        required_columns = ['price_clean', 'accommodates', 'neighbourhood_cleansed', 'neighborhood_idx']
...
class TestModelBuilding:
    ...
    def test_model_parameters(self, fitted_model):
        ...
        required_params = ['mu_alpha', 'mu_beta', 'sigma_alpha', 'sigma_beta',
                          'alpha', 'beta', 'sigma', 'log_price_obs']
...
class TestNeighborhoodComparison:
    ...
    def test_comparison_columns(self, fitted_model):
        ...
        required_cols = ['neighborhood', 'mean_price', 'median_price',
